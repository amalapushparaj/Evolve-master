...
namespace Evolve
{
    public class Evolve : IEvolveConfiguration
    {
        ...
        public string MetadataTableName { get; set; } = "schema_version";
        ...
        //public string SqlMigrationPrefix { get; set; } = "MYPROJECT";
        public string SqlMigrationPrefix { get; set; } = "1504256483";
